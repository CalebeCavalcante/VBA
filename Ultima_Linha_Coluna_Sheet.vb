...
Public Sub Exemplo_Get_Dados()
    ...
    LastRow = getUltimaLinha(MySheet)
    LastColumn = getUltimaColuna(MySheet)
    
    If LastRow < 1 Or LastColumn < 1 Then GoTo ErrorGetInfo
...
End Sub
Public Function getUltimaLinha(ByRef wsPlan As Worksheet, Optional lRowHead As Long) As Long
